...
export function Project({ project }: { project: ProjectType }) {
  return (
    <motion.a
      ...
      variants={item}
      className="flex flex-col gap-2 shrink-0 max-w-[24rem]" rel="noreferrer"
    >
      <img
        src={project.image_url}
        alt="project"
        className="aspect-video w-full rounded-lg  ring ring-transparent hover:ring-primary transition"
      />
